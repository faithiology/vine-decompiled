...
.method public marshall(Lcom/amazonaws/services/dynamodb/model/GetItemRequest;)Lcom/amazonaws/Request;
    ...
    const-string v0, "DynamoDB_20111205.GetItem"
    ...
    new-instance v2, Lcom/amazonaws/util/json/JSONWriter;

    invoke-direct {v2, v1}, Lcom/amazonaws/util/json/JSONWriter;-><init>(Ljava/io/Writer;)V

    invoke-virtual {v2}, Lcom/amazonaws/util/json/JSONWriter;->object()Lcom/amazonaws/util/json/JSONWriter;

    invoke-virtual {p1}, Lcom/amazonaws/services/dynamodb/model/GetItemRequest;->getTableName()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lcom/amazonaws/util/json/JSONWriter;->key(Ljava/lang/String;)Lcom/amazonaws/util/json/JSONWriter;
    ...
    invoke-virtual {v0, v4}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/lang/Object;)Lcom/amazonaws/util/json/JSONWriter;

    :cond_3
    invoke-virtual {p1}, Lcom/amazonaws/services/dynamodb/model/GetItemRequest;->getKey()Lcom/amazonaws/services/dynamodb/model/Key;
    ...
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/Key;->getHashKeyElement()Lcom/amazonaws/services/dynamodb/model/AttributeValue;
    ...
    invoke-virtual {v2, v6}, Lcom/amazonaws/util/json/JSONWriter;->key(Ljava/lang/String;)Lcom/amazonaws/util/json/JSONWriter;
    ...
    invoke-virtual {v2, v0}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/lang/Object;)Lcom/amazonaws/util/json/JSONWriter;
    :try_end_0
    ...
    :cond_8
    :try_start_1
    invoke-virtual {v2}, Lcom/amazonaws/util/json/JSONWriter;->endArray()Lcom/amazonaws/util/json/JSONWriter;
    ...
    invoke-virtual {v2, v5}, Lcom/amazonaws/util/json/JSONWriter;->key(Ljava/lang/String;)Lcom/amazonaws/util/json/JSONWriter;
    ...
    invoke-virtual {v2, v0}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/nio/ByteBuffer;)Lcom/amazonaws/util/json/JSONWriter;
    ...
    :cond_f
    invoke-virtual {v2}, Lcom/amazonaws/util/json/JSONWriter;->endObject()Lcom/amazonaws/util/json/JSONWriter;

    :cond_10
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/Key;->getRangeKeyElement()Lcom/amazonaws/services/dynamodb/model/AttributeValue;
    ...
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/AttributeValue;->getS()Ljava/lang/String;
    ...
    :cond_11
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/AttributeValue;->getN()Ljava/lang/String;
    ...
    :cond_12
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/AttributeValue;->getB()Ljava/nio/ByteBuffer;
    ...
    :cond_13
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/AttributeValue;->getSS()Ljava/util/List;
    ...
    :cond_16
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/AttributeValue;->getNS()Ljava/util/List;
    ...
    :cond_19
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/AttributeValue;->getBS()Ljava/util/List;
    ...
    invoke-virtual {v2, v4}, Lcom/amazonaws/util/json/JSONWriter;->key(Ljava/lang/String;)Lcom/amazonaws/util/json/JSONWriter;
    ...
    :cond_1e
    invoke-virtual {p1}, Lcom/amazonaws/services/dynamodb/model/GetItemRequest;->getAttributesToGet()Ljava/util/List;
    ...
    :cond_21
    invoke-virtual {p1}, Lcom/amazonaws/services/dynamodb/model/GetItemRequest;->isConsistentRead()Ljava/lang/Boolean;
