...
.method public unmarshall(Lcom/amazonaws/transform/StaxUnmarshallerContext;)Lcom/amazonaws/services/simpleemail/model/SendDataPoint;
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/simpleemail/model/SendDataPoint;->setTimestamp(Ljava/util/Date;)V

    goto :goto_0

    :cond_3
    const-string v3, "DeliveryAttempts"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/simpleemail/model/SendDataPoint;->setDeliveryAttempts(Ljava/lang/Long;)V
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/simpleemail/model/SendDataPoint;->setBounces(Ljava/lang/Long;)V

    goto :goto_0

    :cond_5
    const-string v3, "Complaints"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/simpleemail/model/SendDataPoint;->setComplaints(Ljava/lang/Long;)V

    goto :goto_0

    :cond_6
    const-string v3, "Rejects"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/simpleemail/model/SendDataPoint;->setRejects(Ljava/lang/Long;)V
