...
.method public getObject(Lcom/amazonaws/services/s3/model/GetObjectRequest;)Lcom/amazonaws/services/s3/model/S3Object;
    ...
    invoke-static {v3}, Lcom/amazonaws/services/s3/internal/crypto/EncryptionUtils;->getAdjustedCryptoRange([J)[J
    ...
    invoke-virtual {p1, v4, v5, v1, v2}, Lcom/amazonaws/services/s3/model/GetObjectRequest;->setRange(JJ)V
    ...
    :cond_1
    :try_start_0
    invoke-static {v2}, Lcom/amazonaws/services/s3/internal/crypto/EncryptionUtils;->isEncryptionInfoInMetadata(Lcom/amazonaws/services/s3/model/S3Object;)Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-direct {p0, v2}, Lcom/amazonaws/services/s3/AmazonS3EncryptionClient;->decryptObjectUsingMetadata(Lcom/amazonaws/services/s3/model/S3Object;)Lcom/amazonaws/services/s3/model/S3Object;
    :try_end_0
    ...
    :cond_2
    :goto_1
    invoke-static {v0, v3}, Lcom/amazonaws/services/s3/internal/crypto/EncryptionUtils;->adjustOutputToDesiredRange(Lcom/amazonaws/services/s3/model/S3Object;[J)Lcom/amazonaws/services/s3/model/S3Object;
    ...
    :try_start_2
    invoke-static {v1}, Lcom/amazonaws/services/s3/internal/crypto/EncryptionUtils;->isEncryptionInfoInInstructionFile(Lcom/amazonaws/services/s3/model/S3Object;)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-direct {p0, v2, v1}, Lcom/amazonaws/services/s3/AmazonS3EncryptionClient;->decryptObjectUsingInstructionFile(Lcom/amazonaws/services/s3/model/S3Object;Lcom/amazonaws/services/s3/model/S3Object;)Lcom/amazonaws/services/s3/model/S3Object;
    :try_end_2
    ...
    :cond_4
    :try_start_4
    sget-object v0, Lcom/amazonaws/services/s3/AmazonS3EncryptionClient;->log:Lorg/apache/commons/logging/Log;
    ...
    invoke-interface {v0, v4}, Lorg/apache/commons/logging/Log;->warn(Ljava/lang/Object;)V
    :try_end_4
    ...
    .catch Lcom/amazonaws/AmazonClientException; {:try_start_5 .. :try_end_5} :catch_1
    ...
    throw v0
    :try_end_6
    .catch Lcom/amazonaws/AmazonClientException; {:try_start_6 .. :try_end_6} :catch_1
