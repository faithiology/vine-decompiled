...
.method public unmarshall(Lcom/amazonaws/transform/StaxUnmarshallerContext;)Lcom/amazonaws/services/ec2/model/InstanceAttribute;
    ...
    new-instance v1, Lcom/amazonaws/services/ec2/model/InstanceAttribute;

    invoke-direct {v1}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;-><init>()V
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setInstanceId(Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    const-string v3, "instanceType/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setInstanceType(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setKernelId(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setRamdiskId(Ljava/lang/String;)V

    goto :goto_0

    :cond_6
    const-string v3, "userData/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setUserData(Ljava/lang/String;)V

    goto :goto_0

    :cond_7
    const-string v3, "disableApiTermination/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setDisableApiTermination(Ljava/lang/Boolean;)V

    goto/16 :goto_0

    :cond_8
    const-string v3, "instanceInitiatedShutdownBehavior/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setInstanceInitiatedShutdownBehavior(Ljava/lang/String;)V

    goto/16 :goto_0

    :cond_9
    const-string v3, "rootDeviceName/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setRootDeviceName(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->getBlockDeviceMappings()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->getProductCodes()Ljava/util/List;
    ...
    :cond_c
    const-string v3, "ebsOptimized/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/InstanceAttribute;->setEbsOptimized(Ljava/lang/Boolean;)V
