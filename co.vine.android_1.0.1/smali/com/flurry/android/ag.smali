...
# instance fields
.field private by:Lcom/flurry/android/FlurryAds;
...
.method constructor <init>(Lcom/flurry/android/FlurryAds;)V
    ...
    .line 15
    iput-object p1, p0, Lcom/flurry/android/ag;->by:Lcom/flurry/android/FlurryAds;
...
.method final a(Ljava/util/List;)Ljava/util/List;
    ...
    .line 25
    invoke-virtual {v0}, Lcom/flurry/android/cz;->au()J
    ...
    invoke-virtual {v4, v1}, Lcom/flurry/android/SdkAdLog;->c(Ljava/lang/CharSequence;)V
    ...
    .line 31
    :try_start_0
    invoke-virtual {v0}, Lcom/flurry/android/cz;->av()Ljava/util/List;
    ...
    check-cast v1, Lcom/flurry/android/bu;

    .line 34
    invoke-virtual {v1}, Lcom/flurry/android/bu;->ai()Z
    ...
    .line 37
    invoke-virtual {v1}, Lcom/flurry/android/bu;->getType()Ljava/lang/String;
    ...
    .line 38
    invoke-virtual {v1}, Lcom/flurry/android/bu;->M()J
    ...
    .line 39
    invoke-virtual {v1}, Lcom/flurry/android/bu;->getParams()Ljava/util/Map;
    ...
    .line 52
    invoke-virtual {v4, v5}, Lcom/flurry/android/SdkAdLog;->g(Ljava/util/List;)V
    ...
    .line 58
    :cond_3
    iget-object v0, p0, Lcom/flurry/android/ag;->by:Lcom/flurry/android/FlurryAds;

    invoke-virtual {v0, p1}, Lcom/flurry/android/FlurryAds;->d(Ljava/util/List;)V
