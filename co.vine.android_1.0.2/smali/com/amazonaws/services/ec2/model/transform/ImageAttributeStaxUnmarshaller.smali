...
.method public unmarshall(Lcom/amazonaws/transform/StaxUnmarshallerContext;)Lcom/amazonaws/services/ec2/model/ImageAttribute;
    ...
    new-instance v1, Lcom/amazonaws/services/ec2/model/ImageAttribute;

    invoke-direct {v1}, Lcom/amazonaws/services/ec2/model/ImageAttribute;-><init>()V
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->setImageId(Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    const-string v3, "launchPermission/item"
    ...
    invoke-virtual {v1}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->getLaunchPermissions()Ljava/util/List;
    ...
    invoke-virtual {v4, p1}, Lcom/amazonaws/services/ec2/model/transform/LaunchPermissionStaxUnmarshaller;->unmarshall(Lcom/amazonaws/transform/StaxUnmarshallerContext;)Lcom/amazonaws/services/ec2/model/LaunchPermission;
    ...
    invoke-virtual {v1}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->getProductCodes()Ljava/util/List;
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->setKernelId(Ljava/lang/String;)V

    goto :goto_0

    :cond_6
    const-string v3, "ramdisk/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->setRamdiskId(Ljava/lang/String;)V

    goto/16 :goto_0

    :cond_7
    const-string v3, "description/value"
    ...
    invoke-virtual {v1, v3}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->setDescription(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/amazonaws/services/ec2/model/ImageAttribute;->getBlockDeviceMappings()Ljava/util/List;
