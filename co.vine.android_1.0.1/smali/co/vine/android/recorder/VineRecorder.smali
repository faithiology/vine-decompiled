...
# direct methods
.method public varargs constructor <init>(Landroid/app/Activity;IIIIIIII[Ljava/lang/CharSequence;)V
    .locals 3
    .parameter "activity"
    ...
    .line 138
    iput-object p10, p0, Lco/vine/android/recorder/VineRecorder;->mFinishProgressDialogMessage:[Ljava/lang/CharSequence;
...
.method static synthetic access$1500(Lco/vine/android/recorder/VineRecorder;)Landroid/app/ProgressDialog;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1600(Lco/vine/android/recorder/VineRecorder;)[Ljava/lang/CharSequence;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1700(Lco/vine/android/recorder/VineRecorder;)Lco/vine/android/recorder/VineRecorder$FinishProcessRunnable;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1900(Lco/vine/android/recorder/VineRecorder;)Landroid/view/View;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2100(Lco/vine/android/recorder/VineRecorder;)Landroid/app/ProgressDialog;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2200(Lco/vine/android/recorder/VineRecorder;)Ljava/lang/CharSequence;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2400(Lco/vine/android/recorder/VineRecorder;)Lco/vine/android/recorder/ProgressTimer;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2402(Lco/vine/android/recorder/VineRecorder;Lco/vine/android/recorder/ProgressTimer;)Lco/vine/android/recorder/ProgressTimer;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2500(Lco/vine/android/recorder/VineRecorder;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2600(Lco/vine/android/recorder/VineRecorder;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2700(Lco/vine/android/recorder/VineRecorder;)Ljava/lang/ref/WeakReference;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2800(Lco/vine/android/recorder/VineRecorder;)Lco/vine/android/recorder/ProgressView;
    .locals 1
    .parameter "x0"
...
.method private startRecording()V
    ...
    .prologue
    .line 316
    iget-object v1, p0, Lco/vine/android/recorder/VineRecorder;->mActivity:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v2, p0, Lco/vine/android/recorder/VineRecorder;->mFrontFacing:Z

    invoke-virtual {v1, v2}, Lco/vine/android/recorder/RecordController;->openDefaultCamera(Z)Z
    ...
    .line 322
    :cond_1
    new-instance v1, Lco/vine/android/recorder/VineRecorder$FinishProcessTask;

    invoke-direct {v1, p0}, Lco/vine/android/recorder/VineRecorder$FinishProcessTask;-><init>(Lco/vine/android/recorder/VineRecorder;)V

    iput-object v1, p0, Lco/vine/android/recorder/VineRecorder;->mFinishProcessTask:Lco/vine/android/recorder/VineRecorder$FinishProcessTask;

    .line 323
    new-instance v1, Lco/vine/android/recorder/RecordingFile;

    iget-object v2, p0, Lco/vine/android/recorder/VineRecorder;->config:Lco/vine/android/recorder/RecordConfigUtils$RecordConfig;

    const-string v3, "raw"

    iget-object v4, p0, Lco/vine/android/recorder/VineRecorder;->mFiles:Ljava/util/ArrayList;
    ...
    invoke-static {v2, v3, v4, v5}, Lco/vine/android/recorder/RecordConfigUtils;->getPreProcessFile(Lco/vine/android/recorder/RecordConfigUtils$RecordConfig;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {v1, v2}, Lco/vine/android/recorder/RecordingFile;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lco/vine/android/recorder/VineRecorder;->currentRecordingFile:Lco/vine/android/recorder/RecordingFile;
    ...
    invoke-virtual {v2}, Lco/vine/android/recorder/RecordingFile;->getPath()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lco/vine/android/recorder/RecordController;->start(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    iput-wide v1, p0, Lco/vine/android/recorder/VineRecorder;->mCurrentStartTime:J

    .line 326
    const-string v1, "Start recording: {} at {}."
...
.method public onCameraReady(Lco/vine/android/recorder/RecordController;)V
    ...
    iget-object v0, v0, Lco/vine/android/recorder/RecordController;->mCameraInfo:Lco/vine/android/recorder/ConcurrentData$CameraInfo;

    move-object/from16 v17, v0

    move-object/from16 v0, v17

    iget v0, v0, Lco/vine/android/recorder/ConcurrentData$CameraInfo;->originalW:I
    ...
    .line 623
    new-instance v17, Lco/vine/android/recorder/VineRecorder$6;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1, v9, v6}, Lco/vine/android/recorder/VineRecorder$6;-><init>(Lco/vine/android/recorder/VineRecorder;Landroid/widget/RelativeLayout$LayoutParams;Landroid/widget/RelativeLayout$LayoutParams;)V
...
.method public onUiResumed(Landroid/app/Activity;Ljava/lang/Runnable;)V
    ...
    invoke-static {v0, v3}, Lco/vine/android/recorder/VineRecorder$FinishProcessRunnable;->access$1802(Lco/vine/android/recorder/VineRecorder$FinishProcessRunnable;Z)Z
...
.method public switchCamera(Z)V
    ...
    invoke-virtual {v0}, Lco/vine/android/recorder/RecordController;->getCameraProfile()Landroid/media/CamcorderProfile;
