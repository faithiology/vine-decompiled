...
.method public marshall(Lcom/amazonaws/services/dynamodb/model/CreateTableRequest;)Lcom/amazonaws/Request;
    ...
    const-string v0, "DynamoDB_20111205.CreateTable"
    ...
    invoke-virtual {v1, v4}, Lcom/amazonaws/util/json/JSONWriter;->key(Ljava/lang/String;)Lcom/amazonaws/util/json/JSONWriter;

    invoke-virtual {v1}, Lcom/amazonaws/util/json/JSONWriter;->object()Lcom/amazonaws/util/json/JSONWriter;

    invoke-virtual {v2}, Lcom/amazonaws/services/dynamodb/model/KeySchema;->getHashKeyElement()Lcom/amazonaws/services/dynamodb/model/KeySchemaElement;

    move-result-object v4

    if-eqz v4, :cond_6

    const-string v5, "HashKeyElement"

    invoke-virtual {v1, v5}, Lcom/amazonaws/util/json/JSONWriter;->key(Ljava/lang/String;)Lcom/amazonaws/util/json/JSONWriter;

    invoke-virtual {v1}, Lcom/amazonaws/util/json/JSONWriter;->object()Lcom/amazonaws/util/json/JSONWriter;

    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/KeySchemaElement;->getAttributeName()Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/lang/Object;)Lcom/amazonaws/util/json/JSONWriter;

    :cond_4
    invoke-virtual {v4}, Lcom/amazonaws/services/dynamodb/model/KeySchemaElement;->getAttributeType()Ljava/lang/String;
    ...
    invoke-virtual {v5, v4}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/lang/Object;)Lcom/amazonaws/util/json/JSONWriter;

    :cond_5
    invoke-virtual {v1}, Lcom/amazonaws/util/json/JSONWriter;->endObject()Lcom/amazonaws/util/json/JSONWriter;

    :cond_6
    invoke-virtual {v2}, Lcom/amazonaws/services/dynamodb/model/KeySchema;->getRangeKeyElement()Lcom/amazonaws/services/dynamodb/model/KeySchemaElement;
    ...
    invoke-virtual {v2}, Lcom/amazonaws/services/dynamodb/model/KeySchemaElement;->getAttributeName()Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/lang/Object;)Lcom/amazonaws/util/json/JSONWriter;

    :cond_7
    invoke-virtual {v2}, Lcom/amazonaws/services/dynamodb/model/KeySchemaElement;->getAttributeType()Ljava/lang/String;
    ...
    invoke-virtual {v4, v2}, Lcom/amazonaws/util/json/JSONWriter;->value(Ljava/lang/Object;)Lcom/amazonaws/util/json/JSONWriter;
    ...
    invoke-virtual {v2}, Lcom/amazonaws/services/dynamodb/model/ProvisionedThroughput;->getReadCapacityUnits()Ljava/lang/Long;
    ...
    :cond_b
    invoke-virtual {v2}, Lcom/amazonaws/services/dynamodb/model/ProvisionedThroughput;->getWriteCapacityUnits()Ljava/lang/Long;
